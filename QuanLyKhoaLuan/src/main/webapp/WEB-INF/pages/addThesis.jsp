<%-- 
    Document   : addThesis
    Created on : Aug 15, 2023, 2:36:53 PM
    Author     : WIN10
--%>
...
<div class="card-body p-md-5">
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
            ...
            <c:url value="/addThesis" var="action"/>
            <form:form id="sample-form" method="post" action="${action}" modelAttribute="thesiss" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" class="btn btn-primary btn-success" style="width: 100%">
                        <c:choose>
                            <c:when test="${thesiss.id != null}">Cập nhật khóa luận</button></c:when>
