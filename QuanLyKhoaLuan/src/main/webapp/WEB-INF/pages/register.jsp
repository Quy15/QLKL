            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form:form  action="${action}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        <form:input type="text" id="firstName" class="form-control form-control-lg"
                    ...
                    <div class="form-outline mb-3">
                        <form:input type="file" accept="image/png,jpg" id="upload" class="form-control form-control-lg"
                                    name="file" path="file"/>
